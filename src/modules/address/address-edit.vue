<template>
	<div class="address-add">
		<h-input :value="consignee.value" :label="consignee.label" :placeholder="consignee.placeholder" :icon="consignee.icon"></h-input>
		<h-input :type="tel.type" :label="tel.label" :placeholder="tel.placeholder" :icon="tel.icon" :value="tel.value"></h-input>
		<h-input :value="postcode.value" :type="postcode.type" :label="postcode.label" :placeholder="postcode.placeholder" :icon="postcode.icon"></h-input>
		<div class="select">
			<label>省份</label>
		...
		<h-input :value="address.value" :label="address.label" :placeholder="address.placeholder" :icon="address.icon"></h-input>
		<h-checkbox :label="def.label" :value="def.value"></h-checkbox>

		<div class="btn btn-big btn-trash"><span class="icon-trash"></span>删除此地址</div>
